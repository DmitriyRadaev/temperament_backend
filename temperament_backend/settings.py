...
ROOT_URLCONF = 'temperament_backend.urls'
...
WSGI_APPLICATION = 'temperament_backend.wsgi.application'
...
CORS_ALLOWED_ORIGINS = [
    'http://localhost:3000',
    'http://172.26.4.9',
    'http://172.26.4.9:3000',
    'http://172.26.4.9:8082',
    'https://tips.samsmu.ru',
]
